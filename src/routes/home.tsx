...
import { MarqueImage } from "@/components/marquee-img";
        ...
        <div className="flex-col w-full pb-24">
            ...
            <div className="w-full my-12">
                <Marquee pauseOnHover>
                    <MarqueImage img="/assets/img/logo/firebase.png" />
                    <MarqueImage img="/assets/img/logo/meet.png" />
                    <MarqueImage img="/assets/img/logo/zoom.png" />
                    <MarqueImage img="/assets/img/logo/firebase.png" />
                    <MarqueImage img="/assets/img/logo/microsoft.png" />
                    <MarqueImage img="/assets/img/logo/meet.png" />
                    <MarqueImage img="/assets/img/logo/tailwindcss.png" />
                    <MarqueImage img="/assets/img/logo/microsoft.png" />
                </Marquee>
            </div>
